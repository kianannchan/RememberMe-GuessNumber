define(['dart_sdk'], function(dart_sdk) {
  ...
  var intLToStringL = () => (intLToStringL = dart.constFn(dart.fnType(core.String, [core.int])))();
  ...
  var StringLAndStringLToboolL = () => (StringLAndStringLToboolL = dart.constFn(dart.fnType(core.bool, [core.String, core.String])))();
  ...
  var SetOfStringL = () => (SetOfStringL = dart.constFn(core.Set$(core.String)))();
  const CT = Object.create(null);
  var L0 = "package:path/src/style.dart";
  var L7 = "file:///C:/Users/kiana/AppData/Local/Temp/scratch_spacec86e4559-9d28-11ea-956f-e09d31f1f932/packages/path/path.dart";
  ...
  context._validateArgList = function _validateArgList(method, args) {
    for (let i = 1; i < dart.notNull(args[$length]); i = i + 1) {
      ...
      message.write(args[$take](numArgs)[$map](core.String, dart.fn(arg => arg == null ? "null" : "\"" + dart.str(arg) + "\"", StringLToStringL()))[$join](", "));
  ...
  path_set.PathSet = class PathSet extends collection.IterableBase$(core.String) {
    static _create(context) {
      ...
      return LinkedHashSetOfStringL().new({equals: dart.fn((path1, path2) => {
        ...
        }, StringLAndStringLToboolL()), hashCode: dart.fn(path => path == null ? 0 : context.hash(path), StringLTointL()), isValidKey: dart.fn(path => typeof path == 'string' || path == null, dynamicToboolL())});
    }
    get iterator() {
