define(['dart_sdk', 'packages/collection/src/utils'], function(dart_sdk, packages__collection__src__utils) {
  ...
  var L0 = "file:///C:/Users/kiana/AppData/Local/Temp/scratch_spacec86e4559-9d28-11ea-956f-e09d31f1f932/packages/collection/src/algorithms.dart";
  ...
  algorithms._merge = function _merge(T, compare, firstList, firstStart, firstEnd, secondList, secondStart, secondEnd, target, targetOffset) {
    ...
    if (!(dart.notNull(firstStart) < dart.notNull(firstEnd))) dart.assertFailed(null, L0, 255, 10, "firstStart < firstEnd");
    if (!(dart.notNull(secondStart) < dart.notNull(secondEnd))) dart.assertFailed(null, L0, 256, 10, "secondStart < secondEnd");
