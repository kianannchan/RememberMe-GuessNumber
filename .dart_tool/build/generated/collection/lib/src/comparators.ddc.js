define(['dart_sdk'], function(dart_sdk) {
  ...
  var LinkedMapOf_MapEntryL$intL = () => (LinkedMapOf_MapEntryL$intL = dart.constFn(_js_helper.LinkedMap$(equality._MapEntry, core.int)))();
  const CT = Object.create(null);
  var L0 = "file:///C:/Users/kiana/AppData/Local/Temp/scratch_spacec86e4559-9d28-11ea-956f-e09d31f1f932/packages/collection/src/comparators.dart";
  ...
  var C0;
  var _getKey = dart.privateName(equality, "_getKey");
  ...
  equality.EqualityBy$ = dart.generic((E, F) => {
    class EqualityBy extends core.Object {
      equals(e1, e2) {
        ...
        E.as(e1);
        E.as(e2);
        return this[_inner].equals((t0 = e1, this[_getKey](t0)), (t0$ = e2, this[_getKey](t0$)));
      }
      hash(e) {
        let t0;
        E.as(e);
        return this[_inner].hash((t0 = e, this[_getKey](t0)));
      }
      isValidKey(o) {
        let t0;
        if (E.is(o)) {
          let value = (t0 = o, this[_getKey](t0));
  ...
  equality.IterableEquality$ = dart.generic(E => {
    ...
    class IterableEquality extends core.Object {
      ...
      equals(elements1, elements2) {
        IterableOfEL().as(elements1);
        IterableOfEL().as(elements2);
  ...
  equality._UnorderedEquality$ = dart.generic((E, T) => {
    var HashMapOfEL$intL = () => (HashMapOfEL$intL = dart.constFn(collection.HashMap$(E, core.int)))();
    class _UnorderedEquality extends core.Object {
      ...
      equals(elements1, elements2) {
        ...
        if (elements1 == elements2) return true;
        if (elements1 == null || elements2 == null) return false;
        let counts = HashMapOfEL$intL().new({equals: dart.bind(this[_elementEquality], 'equals'), hashCode: dart.bind(this[_elementEquality], 'hash'), isValidKey: dart.bind(this[_elementEquality], 'isValidKey')});
        let length = 0;
