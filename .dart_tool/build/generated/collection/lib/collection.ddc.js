define(['dart_sdk', 'packages/collection/src/canonicalized_map', 'packages/collection/src/utils'], function(dart_sdk, packages__collection__src__canonicalized_map, packages__collection__src__utils) {
  ...
  var L1 = "file:///C:/Users/kiana/AppData/Local/Temp/scratch_spacec86e4559-9d28-11ea-956f-e09d31f1f932/packages/collection/src/queue_list.dart";
  ...
  combined_iterable.CombinedIterableView$ = dart.generic(T => {
    var _CombinedIteratorOfTL = () => (_CombinedIteratorOfTL = dart.constFn(combined_iterable._CombinedIterator$(T)))();
    ...
    var IterableLOfTLToboolL = () => (IterableLOfTLToboolL = dart.constFn(dart.fnType(core.bool, [IterableOfTL()])))();
    var intLAndIterableLOfTLTointL = () => (intLAndIterableLOfTLTointL = dart.constFn(dart.fnType(core.int, [core.int, IterableOfTL()])))();
    class CombinedIterableView extends collection.IterableBase$(T) {
      ...
      get iterator() {
        return new (_CombinedIteratorOfTL()).new(this[_iterables][$map](IteratorOfTL(), dart.fn(i => i[$iterator], IterableLOfTLToIteratorLOfTL()))[$iterator]);
      }
      contains(element) {
      ...
      get length() {
        return this[_iterables][$fold](core.int, 0, dart.fn((length, i) => dart.notNull(length) + dart.notNull(i[$length]), intLAndIterableLOfTLTointL()));
      }
    }
  ...
  queue_list.QueueList$ = dart.generic(E => {
    ...
    class QueueList extends Object_ListMixin$36 {
      ...
      static _nextPowerOf2(number) {
        if (!(dart.notNull(number) > 0)) dart.assertFailed(null, L1, 194, 12, "number > 0");
      ...
      [_writeToList](target) {
        if (!(dart.notNull(target[$length]) >= dart.notNull(this.length))) dart.assertFailed(null, L1, 222, 12, "target.length >= length");
      ...
      [_preGrow](newElementCount) {
        if (!(dart.notNull(newElementCount) >= dart.notNull(this.length))) dart.assertFailed(null, L1, 237, 12, "newElementCount >= length");
  ...
  union_set.UnionSet$ = dart.generic(E => {
    ...
    var intLAndSetLOfELTointL = () => (intLAndSetLOfELTointL = dart.constFn(dart.fnType(core.int, [core.int, SetOfEL()])))();
    var SetLOfELToSetLOfEL = () => (SetLOfELToSetLOfEL = dart.constFn(dart.fnType(SetOfEL(), [SetOfEL()])))();
    var _HashSetOfEL = () => (_HashSetOfEL = dart.constFn(collection._HashSet$(E)))();
    var ELToboolL = () => (ELToboolL = dart.constFn(dart.fnType(core.bool, [E])))();
    var SetLOfELToboolL = () => (SetLOfELToboolL = dart.constFn(dart.fnType(core.bool, [SetOfEL()])))();
    var SetLOfELToEL = () => (SetLOfELToEL = dart.constFn(dart.fnType(E, [SetOfEL()])))();
    ...
    class UnionSet extends SetBase_UnmodifiableSetMixin$36 {
      get length() {
        return dart.test(this[_disjoint]) ? this[_sets$][$fold](core.int, 0, dart.fn((length, set) => dart.notNull(length) + dart.notNull(set[$length]), intLAndSetLOfELTointL())) : this[_iterable][$length];
      }
      get iterator() {
        return this[_iterable][$iterator];
      }
      get [_iterable]() {
        return dart.test(this[_disjoint]) ? this[_sets$][$expand](E, dart.fn(set => set, SetLOfELToSetLOfEL())) : this[_dedupIterable];
      }
      get [_dedupIterable]() {
        let seen = new (_HashSetOfEL()).new();
        return this[_sets$][$expand](E, dart.fn(set => set, SetLOfELToSetLOfEL()))[$where](dart.fn(element => {
      ...
      lookup(element) {
        ...
        return this[_sets$][$map](E, dart.fn(set => set.lookup(element), SetLOfELToEL()))[$firstWhere](dart.fn(result => result != null, ELToboolL()), {orElse: dart.fn(() => null, VoidToNullN())});
      }
      toSet() {
        let result = new (_HashSetOfEL()).new();
  ...
  combined_list.CombinedListView$ = dart.generic(T => {
    ...
    var intLAndListLOfTLTointL = () => (intLAndListLOfTLTointL = dart.constFn(dart.fnType(core.int, [core.int, ListOfTL()])))();
    var IterableOfTL = () => (IterableOfTL = dart.constFn(core.Iterable$(T)))();
    class CombinedListView extends collection.ListBase$(T) {
      ...
      get length() {
        return this[_lists$][$fold](core.int, 0, dart.fn((length, list) => dart.notNull(length) + dart.notNull(list[$length]), intLAndListLOfTLTointL()));
      }
      _get(index) {
      ...
      get [_source$]() {
        return IterableOfTL().as(this[$noSuchMethod](new core._Invocation.getter(C0 || CT.C0)));
      }
    }
  ...
  combined_map.CombinedMapView$ = dart.generic((K, V) => {
    var _DeduplicatingIterableViewOfKL = () => (_DeduplicatingIterableViewOfKL = dart.constFn(combined_map._DeduplicatingIterableView$(K)))();
    var CombinedIterableViewOfKL = () => (CombinedIterableViewOfKL = dart.constFn(combined_iterable.CombinedIterableView$(K)))();
    var IterableOfKL = () => (IterableOfKL = dart.constFn(core.Iterable$(K)))();
    var MapOfKL$VL = () => (MapOfKL$VL = dart.constFn(core.Map$(K, V)))();
    var MapLOfKL$VLToIterableLOfKL = () => (MapLOfKL$VLToIterableLOfKL = dart.constFn(dart.fnType(IterableOfKL(), [MapOfKL$VL()])))();
    class CombinedMapView extends collection.UnmodifiableMapBase$(K, V) {
      ...
      get keys() {
        return new (_DeduplicatingIterableViewOfKL()).new(new (CombinedIterableViewOfKL()).new(this[_maps$][$map](IterableOfKL(), dart.fn(m => m[$keys], MapLOfKL$VLToIterableLOfKL()))));
      }
    }
  ...
  combined_map._DeduplicatingIterableView$ = dart.generic(T => {
    var _DeduplicatingIteratorOfTL = () => (_DeduplicatingIteratorOfTL = dart.constFn(combined_map._DeduplicatingIterator$(T)))();
  ...
  combined_map._DeduplicatingIterator$ = dart.generic(T => {
    var _HashSetOfTL = () => (_HashSetOfTL = dart.constFn(collection._HashSet$(T)))();
  ...
  union_set_controller.UnionSetController$ = dart.generic(E => {
    var SetOfEL = () => (SetOfEL = dart.constFn(core.Set$(E)))();
    var _HashSetOfSetLOfEL = () => (_HashSetOfSetLOfEL = dart.constFn(collection._HashSet$(SetOfEL())))();
    var UnionSetOfEL = () => (UnionSetOfEL = dart.constFn(union_set.UnionSet$(E)))();
    class UnionSetController extends core.Object {
      get set() {
        return this[_set];
      }
      add(component) {
        SetOfEL().as(component);
    ...
    (UnionSetController.new = function(opts) {
      let disjoint = opts && 'disjoint' in opts ? opts.disjoint : false;
      this[_set] = null;
      this[_sets] = new (_HashSetOfSetLOfEL()).new();
  ...
  equality_map.EqualityMap$ = dart.generic((K, V) => {
    var LinkedHashMapOfKL$VL = () => (LinkedHashMapOfKL$VL = dart.constFn(collection.LinkedHashMap$(K, V)))();
