define(['dart_sdk', 'packages/path/path', 'packages/collection/collection', 'packages/term_glyph/src/generated/ascii_glyph_set'], function(dart_sdk, packages__path__path, packages__collection__collection, packages__term_glyph__src__generated__ascii_glyph_set) {
  ...
  var MapOfSourceSpanL$StringL = () => (MapOfSourceSpanL$StringL = dart.constFn(core.Map$(span.SourceSpan, core.String)))();
  var StringLAndStringLAndMapLOfSourceSpanL$StringL__ToStringL = () => (StringLAndStringLAndMapLOfSourceSpanL$StringL__ToStringL = dart.constFn(dart.fnType(core.String, [core.String, core.String, MapOfSourceSpanL$StringL()], {color: core.bool, primaryColor: core.String, secondaryColor: core.String}, {})))();
  var StringLAndMapLOfSourceSpanL$StringL__ToStringL = () => (StringLAndMapLOfSourceSpanL$StringL__ToStringL = dart.constFn(dart.fnType(core.String, [core.String, MapOfSourceSpanL$StringL()], {color: core.bool, primaryColor: core.String, secondaryColor: core.String}, {})))();
  var intLTovoid = () => (intLTovoid = dart.constFn(dart.fnType(dart.void, [core.int])))();
  var intLAndintLToSourceSpanL = () => (intLAndintLToSourceSpanL = dart.constFn(dart.fnType(span.SourceSpan, [core.int], [core.int])))();
  var JSArrayOf_HighlightL = () => (JSArrayOf_HighlightL = dart.constFn(_interceptors.JSArray$(highlighter._Highlight)))();
  var VoidToStringL = () => (VoidToStringL = dart.constFn(dart.fnType(core.String, [])))();
  var _HighlightLToboolL = () => (_HighlightLToboolL = dart.constFn(dart.fnType(core.bool, [highlighter._Highlight])))();
  var _LineLTointL = () => (_LineLTointL = dart.constFn(dart.fnType(core.int, [highlighter._Line])))();
  var TLAndTLToTL = () => (TLAndTLToTL = dart.constFn(dart.gFnType(T => [T, [T, T]], T => [core.num])))();
  var _LineLToUriL = () => (_LineLToUriL = dart.constFn(dart.fnType(core.Uri, [highlighter._Line])))();
  var dynamicTodynamic = () => (dynamicTodynamic = dart.constFn(dart.fnType(dart.dynamic, [dart.dynamic])))();
  var _HighlightLAnd_HighlightLTointL = () => (_HighlightLAnd_HighlightLTointL = dart.constFn(dart.fnType(core.int, [highlighter._Highlight, highlighter._Highlight])))();
  var JSArrayOf_LineL = () => (JSArrayOf_LineL = dart.constFn(_interceptors.JSArray$(highlighter._Line)))();
  var ListOf_LineL = () => (ListOf_LineL = dart.constFn(core.List$(highlighter._Line)))();
  var ListOf_HighlightL = () => (ListOf_HighlightL = dart.constFn(core.List$(highlighter._Highlight)))();
  var ListLOf_HighlightLToListLOf_LineL = () => (ListLOf_HighlightLToListLOf_LineL = dart.constFn(dart.fnType(ListOf_LineL(), [ListOf_HighlightL()])))();
  var VoidToNullN = () => (VoidToNullN = dart.constFn(dart.fnType(core.Null, [])))();
  var VoidTovoid = () => (VoidTovoid = dart.constFn(dart.fnType(dart.void, [])))();
  var VoidToSourceSpanWithContextL = () => (VoidToSourceSpanWithContextL = dart.constFn(dart.fnType(span_with_context.SourceSpanWithContext, [])))();
  var JSArrayOfintL = () => (JSArrayOfintL = dart.constFn(_interceptors.JSArray$(core.int)))();
  var intLAndintLToFileSpanL = () => (intLAndintLToFileSpanL = dart.constFn(dart.fnType(file.FileSpan, [core.int], [core.int])))();
  ...
  var L4 = "file:///C:/Users/kiana/AppData/Local/Temp/scratch_spacec86e4559-9d28-11ea-956f-e09d31f1f932/packages/source_span/src/highlighter.dart";
  ...
  (highlighter.Highlighter.__ = function(_lines, _primaryColor, _secondaryColor) {
    ...
    this[_maxMultilineSpans] = _lines[$map](core.int, dart.fn(line => line.highlights[$where](dart.fn(highlight => utils.isMultiline(highlight.span), _HighlightLToboolL()))[$length], _LineLTointL()))[$reduce](dart.gbind(C0 || CT.C0, core.int));
    this[_multipleFiles] = !dart.test(utils.isAllTheSame(_lines[$map](core.Object, dart.fn(line => line.url, _LineLToUriL()))));
    ;
  }).prototype = highlighter.Highlighter.prototype;
  ...
  file._FileSpan = class _FileSpan extends span_mixin.SourceSpanMixin {
    ...
    get [_context$]() {
      return core.String.as(this[$noSuchMethod](new core._Invocation.getter(C1 || CT.C1)));
    }
  };
