define(['dart_sdk', 'packages/source_span/source_span'], function(dart_sdk, packages__source_span__source_span) {
  ...
  var ListOfMatchL = () => (ListOfMatchL = dart.constFn(core.List$(core.Match)))();
  ...
  span_scanner.SpanScanner = class SpanScanner extends string_scanner.StringScanner {
    ...
    get [_column$]() {
      return core.int.as(this[$noSuchMethod](new core._Invocation.getter(C0 || CT.C0)));
    }
    ...
    get [_betweenCRLF$]() {
      return core.bool.as(this[$noSuchMethod](new core._Invocation.getter(C3 || CT.C3)));
    }
    [_newlinesIn$](text) {
      return ListOfMatchL().as(this[$noSuchMethod](new core._Invocation.method(C4 || CT.C4, null, [text])));
    }
    set [_column$](value) {
  ...
  span_scanner._SpanScannerState = class _SpanScannerState extends core.Object {
    ...
    get [_scanner$]() {
      return line_scanner.LineScanner.as(this[$noSuchMethod](new core._Invocation.getter(C7 || CT.C7)));
    }
  };
  ...
  relative_span_scanner.RelativeSpanScanner = class RelativeSpanScanner extends string_scanner.StringScanner {
    ...
    get [_column$]() {
      return core.int.as(this[$noSuchMethod](new core._Invocation.getter(C8 || CT.C8)));
    }
    get [_sourceFile]() {
      return file.SourceFile.as(this[$noSuchMethod](new core._Invocation.getter(C9 || CT.C9)));
    }
    [_adjustLineAndColumn$](character) {
      return this[$noSuchMethod](new core._Invocation.method(C10 || CT.C10, null, [character]));
    }
    get [_line$]() {
      return core.int.as(this[$noSuchMethod](new core._Invocation.getter(C11 || CT.C11)));
    }
    get [_betweenCRLF$]() {
      return core.bool.as(this[$noSuchMethod](new core._Invocation.getter(C12 || CT.C12)));
    }
    [_newlinesIn$](text) {
      return ListOfMatchL().as(this[$noSuchMethod](new core._Invocation.method(C13 || CT.C13, null, [text])));
    }
    get [_lastSpan]() {
      return file.FileSpan.as(this[$noSuchMethod](new core._Invocation.getter(C14 || CT.C14)));
    }
    set [_column$](value) {
  ...
  relative_span_scanner._SpanScannerState = class _SpanScannerState extends core.Object {
    ...
    get [_scanner$]() {
      return line_scanner.LineScanner.as(this[$noSuchMethod](new core._Invocation.getter(C18 || CT.C18)));
    }
  };
  ...
  eager_span_scanner._EagerSpanScannerState = class _EagerSpanScannerState extends core.Object {
    ...
    get [_scanner$]() {
      return line_scanner.LineScanner.as(this[$noSuchMethod](new core._Invocation.getter(C19 || CT.C19)));
    }
  };
